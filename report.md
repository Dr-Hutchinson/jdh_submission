...
| Tag | Cell | Remark |
| --- | --- | --- |
| image/png | 5 | Image is not tagged properly [Check here ](https://journalofdigitalhistory.org/en/notebook-viewer/JTJGcHJveHktZ2l0aHVidXNlcmNvbnRlbnQlMkZEci1IdXRjaGluc29uJTJGamRoX3N1Ym1pc3Npb24lMkZtYWluJTJGYXJ0aWNsZS5pcHluYg==?idx=5) |
| text/html | 35 | Tags are not defined for the cell |
| image/png | 41 | Tags are not defined for the cell |
| image/png | 46 | Tags are not defined for the cell |
...
- Cell 9 - Encountered a start tag: a
- Cell 9 - Encountered a start tag: i
- Cell 9 - Encountered an end tag: i
- Cell 9 - Encountered an end tag: a
- Cell 9 - Encountered a start tag: a
- Cell 9 - Encountered an end tag: a
- Cell 9 - Encountered a start tag: a
...
- Cell 14 - Encountered a start tag: a
- Cell 14 - Encountered a start tag: i
- Cell 14 - Encountered an end tag: i
- Cell 14 - Encountered an end tag: a
- Cell 14 - Encountered a start tag: a
- Cell 14 - Encountered an end tag: a
- Cell 14 - Encountered a start tag: a
...
- Cell 17 - Encountered a start tag: i
- Cell 17 - Encountered an end tag: i
...
- Cell 21 - Encountered an end tag: a
- Cell 21 - Encountered a start tag: a
- Cell 21 - Encountered a start tag: i
- Cell 21 - Encountered an end tag: i
- Cell 21 - Encountered an end tag: a
- Cell 21 - Encountered a start tag: a
- Cell 21 - Encountered an end tag: a
- Cell 21 - Encountered a start tag: a
...
- Cell 29 - Encountered a start tag: i
- Cell 29 - Encountered an end tag: i
- Cell 29 - Encountered an end tag: a
- Cell 29 - Encountered a start tag: a
- Cell 29 - Encountered an end tag: a
- Cell 31 - Encountered a start tag: a
- Cell 31 - Encountered a start tag: i
- Cell 31 - Encountered an end tag: i
- Cell 31 - Encountered an end tag: a
- Cell 31 - Encountered a start tag: a
- Cell 31 - Encountered an end tag: a
- Cell 32 - Encountered a start tag: a
- Cell 32 - Encountered an end tag: a
- Cell 37 - Encountered a start tag: br
- Cell 37 - Encountered a start tag: br
- Cell 37 - Encountered a start tag: br
- Cell 37 - Encountered a start tag: div
- Cell 37 - Encountered a start tag: div
- Cell 37 - Encountered a start tag: h4
- Cell 37 - Encountered an end tag: h4
- Cell 37 - Encountered a start tag: div
- Cell 37 - Encountered a start tag: h4
- Cell 37 - Encountered an end tag: h4
- Cell 37 - Encountered a start tag: br
...
- Cell 43 - Encountered a start tag: a
- Cell 43 - Encountered an end tag: a
- Cell 43 - Encountered a start tag: a
- Cell 43 - Encountered a start tag: i
- Cell 43 - Encountered an end tag: i
- Cell 43 - Encountered an end tag: a
- Cell 44 - Encountered a start tag: span
- Cell 44 - Encountered an end tag: span
- Cell 44 - Encountered a start tag: span
- Cell 44 - Encountered an end tag: span
- Cell 44 - Encountered a start tag: div
- Cell 44 - Encountered a start tag: div
- Cell 44 - Encountered a start tag: h4
- Cell 44 - Encountered an end tag: h4
- Cell 44 - Encountered a start tag: div
- Cell 44 - Encountered a start tag: div
- Cell 44 - Encountered a start tag: h4
- Cell 44 - Encountered an end tag: h4
...
- Cell 44 - Encountered a start tag: h4
- Cell 44 - Encountered an end tag: h4
- Cell 48 - Encountered a start tag: a
- Cell 48 - Encountered an end tag: a
- Cell 48 - Encountered a start tag: a
- Cell 48 - Encountered an end tag: a
- Cell 48 - Encountered a start tag: a
- Cell 48 - Encountered an end tag: a
...
- Cell 54 - Encountered a start tag: a
- Cell 54 - Encountered an end tag: a
- Cell 58 - Encountered a start tag: a
- Cell 58 - Encountered an end tag: a
- Cell 58 - Encountered a start tag: a
- Cell 58 - Encountered an end tag: a
- Cell 58 - Encountered a start tag: a
- Cell 58 - Encountered an end tag: a
...
- Cell 63 - Encountered a start tag: div
- Cell 63 - Encountered a start tag: i
- Cell 63 - Encountered an end tag: i
- Cell 63 - Encountered a start tag: a
- Cell 63 - Encountered an end tag: a
- Cell 63 - Encountered a start tag: div
- Cell 63 - Encountered a start tag: i
- Cell 63 - Encountered an end tag: i
- Cell 63 - Encountered a start tag: i
...
5. https://licensebuttons.net/l/by-nc-nd/4.0/88x31.png
6. https://creativecommons.org/licenses/by-nc-nd/4.0/
8. https://huggingface.co/spaces/open-llm-leaderboard/open_llm_leaderboard
9. https://huggingface.co/spaces/uonlp/open_multilingual_llm_leaderboard
10. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/main/media/Table%201%20-%20MMLU%20Benchmark%20Performance.png
11. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/hayseed.png
13. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/prompts/primary_source_analysis.txt
15. https://huggingface.co/docs/transformers/en/model_doc/whisper
18. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/revised_original_transcript_formatted.txt
19. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/revised_whisper_transcript_formatted.txt
20. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/die_lotse_6-30-45_1.png
21. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/prompts/ocr_prompt.txt
22. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/die_lotse_1_ocr_output.txt
23. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/die_lotse_1_human_correction.txt
24. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/die_lotse_2_ocr_output.txt
25. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/die_lotse_2_human_correction.txt
26. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/prompts/gpt_vision_prompt.txt
27. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/prompts/vision_few_shot.txt
28. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/die_lotse_3-15-45_1.png
30. https://spacy.io/usage/facts-figures
31. https://raw.githubusercontent.com/Dr-Hutchinson/jdh_submission/refs/heads/main/media/prompts/metadata_extraction_prompt.txt
33. https://storm.genie.stanford.edu/
34. https://github.com/Dr-Hutchinson/jdh_submission/blob/main/media/STORM%20Essay%20-%20Abraham%20Lincoln's%20views%20on%20Japan..pdf
44. https://www.digitalhumanities.org/dhq/vol/15/4/000574/000574.html">https://www.digitalhumanities.org/dhq/vol/15/4/000574/000574.html</a>.</div>
